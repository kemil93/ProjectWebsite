    ...
    <header>
        ...
        <main>
            <section class="d-flex flex-wrap justify-content-evenly">
                ...
                <article class="">
                    <div class="card bg-body-primary" style="width: 18rem;">
                    <h5 class="card-title text-center fw-bolder text-primary">Goblin</h5>
                    <hr class="text-primary fw-bolder">
                    <img src="{{ asset('/images/goblin.png') }}" class="card-img-top shadow-lg img-fluid" alt="...">
                    <hr class="text-primary">
                    <div class="card-body shadow-lg">
                    <p class="card-text text-center">Enemies with no particular resistances</p>
                    </div>
                    </div>
                </article>
                <article class="">
                    <div class="card bg-body-primary" style="width: 18rem;">
                    <h5 class="card-title text-center fw-bolder text-primary">Slime</h5>
                    <hr class="text-primary fw-bolder">
                    <img src="{{ asset('/images/slime.png') }}" class="card-img-top shadow-lg img-fluid" alt="...">
                    <hr class="text-primary">
                    <div class="card-body shadow-lg">
                    <p class="card-text text-center">Enemies with no particular resistances</p>
                    </div>
